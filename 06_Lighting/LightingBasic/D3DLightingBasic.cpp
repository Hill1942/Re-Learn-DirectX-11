...
D3DLightingBasic::D3DLightingBasic(HINSTANCE hInstance)
	:D3DApp(hInstance),
	 mLandIB(0),
	 mLandVB(0),
	 mWaveIB(0),
...
D3DLightingBasic::~D3DLightingBasic(void)
{
	ReleaseCOM(mLandVB);
	ReleaseCOM(mLandIB);
	ReleaseCOM(mWaveVB);
...
void D3DLightingBasic::OnResize()
{
	D3DApp::OnResize();
...
void D3DLightingBasic::DrawScene()
{
...
void D3DLightingBasic::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}
void D3DLightingBasic::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void D3DLightingBasic::BuildLandGemetryBuffers()
{
...
void D3DLightingBasic::BuildWaveGemetryBuffers()
{
...
void D3DLightingBasic::BuildVertexLayout()
{
...
void D3DLightingBasic::LoadShader()
{
	DWORD shaderFlags = 0;
...
void D3DLightingBasic::BuildRasterState()
{
...
float D3DLightingBasic::GetHillHeight(float x, float z)const
{
	return 0.3f*( z*sinf(0.1f*x) + x*cosf(0.1f*z) );
}

XMFLOAT3 D3DLightingBasic::GetHillNormal(float x, float z)const
{
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
